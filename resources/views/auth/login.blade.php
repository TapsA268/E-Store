        ...
        <div class="row align-items-center g-lg-5 py-5">
          ...
          <div class="col-md-10 mx-auto col-lg-5 border rounded-3 bg-body-primary">
            ...
            <form id="login-form" action="{{route('login')}}" method="post" class="p-3 p-md-4">
              ...
              <div class="g-recaptcha mt-4" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}" data-theme="dark"></div>
              ...
              @endif
              <br>
              <button class="btn btn-primary" id="submit"type="submit">Acceder</button>
            </form>
            <p>¿Aún no tienes una cuenta? <a href="{{route('register')}}" class="btn btn-link">Regístrate Aquí</a></p>
          </div>
        </div>    
    </div>
