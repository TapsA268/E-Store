...
@section('content')
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
        <div class="text-bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            ...
            <div id="imagen" class="bg-dark shadow-sm mx-auto"
                style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
                <a href="{{ route('products_smartphone') }}"><img src="media\sara-kurfess-6lcT2kRPvnI-unsplash.jpg"
                        alt="" width="260px" height="290px"></a>
            </div>
        </div>
        <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            ...
            <div id="imagen" class="bg-body-tertiary shadow-sm mx-auto"
                style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
                <a href="{{ route('products_laptop') }}"><img src="media\ales-nesetril-Im7lZjxeLhg-unsplash.jpg"
                        alt="" width="260px" height="300px"></a>
            </div>
        </div>
        <div class="text-bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div class="my-3 py-3">
            ...
            <div id="imagen" class="bg-dark shadow-sm mx-auto"
                style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
                <a href="{{ route('products_smartTV') }}"><img src="media\jonas-leupe-dZmNJKFDuVI-unsplash.jpg"
                        alt="" width="260px" height="300px"></a>
            </div>
        </div>
    </div>
