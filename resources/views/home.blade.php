<!-- se hace una extensión de la plantilla para catalogo -->
@extends('layouts.layout_categories')

<!-- en la sección de nombre 'content' se agrega  -->
@section('content')
<div class="container">
...
<!-- se incluye la inyección del modal de una vista parcial separada para tener el modulo
distribuido en la carpeta de products -->
            ...
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                ...
                <form action="{{route('add')}}" method="post">
                  <!-- token de seguridad en el formulario -->
                  @csrf
